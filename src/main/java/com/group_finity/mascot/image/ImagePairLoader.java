...
public class ImagePairLoader
{
    ...
    /**
     * Load image from external file first, fallback to classpath resource
     */
    private static BufferedImage loadImage(final String imagePath) throws IOException {
        ...
        // 如果都失败了，抛出异常
        throw new IOException("Cannot find image: " + imagePath + " (tried external path: " + externalFile.getAbsolutePath() + " and classpath resource)");
    }
